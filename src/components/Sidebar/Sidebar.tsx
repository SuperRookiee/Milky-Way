    ...
    return (
        <Box height='100vh' borderRight='1px solid' borderColor='whiteAlpha.300' py={8} position='sticky' top={0}
            ...
            <Flex direction='column' gap={10} w='full' height='full'>
                ...
                {/* LOGOUT */}
                <Tooltip hasArrow label='Logout' placement='right' ml={1} openDelay={300}
                         display={{base: "block", md: "none"}}>
                    <Flex onClick={handleLogout} alignItems='center' gap={4} _hover={{bg: "whiteAlpha.400"}}
                          borderRadius={6} p={2} w={{base: 10, md: "full"}} mt='auto'
